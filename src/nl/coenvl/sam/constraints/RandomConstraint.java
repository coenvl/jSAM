 ...
 * @since 26 feb. 2016
 */
public class RandomConstraint<T extends DiscreteVariable<V>, V> extends CostMatrixConstraint<T, V> {

	public static final double MAX_COST = 1;

	public RandomConstraint(T var1, T var2) {
		super(var1,
				var2,
	...
	/**
	 * Create a matrix of random doubles of size x by y. Each element is
	 * generated by a call to Math.random, multiplied by the MAX_COST variable.
	 * Therefore the domain of the random values is [0,MAX_COST).
	 * 
	 * @param x
	 * @param y
	 * @return
